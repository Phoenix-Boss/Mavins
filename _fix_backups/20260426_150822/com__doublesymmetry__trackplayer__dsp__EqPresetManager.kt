 ...
 * Track â†’ preset assignment: JSON file in files/eq_presets/track_assignments.json
 *
 * EqPreset fields:
 *   name            â€” display name (used as file key)
 *   graphicGains    â€” FloatArray[31] graphic EQ band gains in dB
 *   parametricGains â€” FloatArray[31] parametric EQ band gains in dB
 *   parametricFreqs â€” DoubleArray[31] parametric EQ band center frequencies in Hz
 *   qValues         â€” DoubleArray[31] per-band Q factor
 *   preampDb        â€” Float global preamp gain in dB
 *   eqMode          â€” String "GRAPHIC" | "PARAMETRIC" | "PARALLEL"
 *   smoothingRampMs â€” Double gain smoothing ramp time in ms
 */
class EqPresetManager(private val context: Context) {
    ...
    // â”€â”€ Preset CRUD â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    fun savePreset(preset: EqPreset): Boolean {
        return try {
            ...
            Log.d(TAG, "Saved preset: ${preset.name} â†’ ${file.name}")
            true
        } catch (e: Exception) {
    ...
    fun deletePreset(name: String): Boolean {
        return try {
            ...
            if (file.exists()) {
                ...
                Log.w(TAG, "Cannot delete â€” preset not found: $name")
                false
            }
        } catch (e: Exception) {
    ...
    // â”€â”€ Trackâ€“preset assignment â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Assignments file â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
