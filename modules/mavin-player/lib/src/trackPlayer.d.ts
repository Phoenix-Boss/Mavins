...
import type { AddTrack, AndroidAutoBrowseTree, EventPayloadByEvent, NowPlayingMetadata, PlaybackState, PlayerOptions, Progress, ServiceHandler, Track, TrackMetadataBase, UpdateOptions } from './interfaces';
/**
 ...
 */
export declare function updateOptions(options?: UpdateOptions): Promise<void>;
/**
