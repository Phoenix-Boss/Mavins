...
class MusicService : HeadlessJsMediaService() {
    ...
    var renderersFactory: MavinRenderersFactory? = null
    ...
    fun setupPlayer(playerOptions: Bundle?) {
        ...
        renderersFactory = MavinRenderersFactory(
            this@MusicService,
            replayGain,
            sampleRateConverter,
            equalizer,
        ...
        player = QueuedAudioPlayer(this@MusicService, options, renderersFactory!!)
        fakePlayer.release()
