...
import android.media.AudioDeviceCallback      // FIX: was missing â€” caused "Unresolved reference: AudioDeviceCallback"
...
class UsbDacController(private val context: Context) {
    ...
    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    // AudioDeviceCallback â€” API 23+ only.
    ...
    private fun getSupportedSampleRates(device: AudioDeviceInfo): List<Int> {
        ...
        if (deviceRates.isEmpty()) {
            // Device reports nothing â€” return the full hi-res list as a safe fallback
    ...
    // failures because the compiler couldn't resolve AudioDeviceCallback â€”
