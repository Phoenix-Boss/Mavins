...
/**
 * TrackData — Immutable data class representing a single playable track.
 *
...
data class TrackData(
    ...
    /** Playback URI — local file path, http/https stream, or content:// URI. */
    val uri: String,
    ...
    /** RNTP v5: Star or percentage rating (0.0–1.0 normalised). */
    val rating: Float? = null,

    /** RNTP v5: Track type — "default", "dash", "hls", "smoothstreaming". */
