// components/sections/ThrowbacksSection.tsx
/**
 * ThrowbacksSection — Theme-Aware Version
 */
      ...
      <Animated.View style={[styles.card, { opacity: fadeAnim }]}>
        ...
        <View style={styles.actions}>
          ...
          {shuffledItems.length > 1 && (
            <TouchableOpacity style={[styles.actionBtn, { borderColor: colors.borderGold }]} onPress={handleSkip} hitSlop={10}>
              <Ionicons name="play-skip-forward-outline" size={20} color={colors.gold} />
            </TouchableOpacity>
          )}
        </View>
        ...
        <TouchableOpacity style={[styles.playBtn, { backgroundColor: colors.gold, shadowColor: colors.gold }]} onPress={handlePlay} activeOpacity={0.85}>
